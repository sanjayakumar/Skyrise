...
void do_autonomous_red_skyrise(int x_offset, int y_offset) {
	...
	signed_move('l', 85 - SKY1_X_OFFSET, 127);
	wait1Msec(100);
	move('b', 500, 127);
	wait1Msec(300);
	wait_for_slide_done();
...
void do_autonomous_red_cubes_only() {
	/*move_arm_to_position(100);
	wait_for_arm_done();
	move_arm_to_position(0);
	wait_for_arm_done();
	move_arm_to_position(200);
	wait_for_arm_done();
	move_arm_to_position(0);
	wait_for_arm_done();
	move_arm_to_position(300);
	...
	move_arm_to_position(0);
	wait_for_arm_done();
	move_arm_to_position(400);
	wait_for_arm_done();
	move_arm_to_position(0);
	wait_for_arm_done();
	move_arm_to_position(500);
	wait_for_arm_done();
	move_arm_to_position(0);
	wait_for_arm_done();
	return;*/
...
void do_autonomous_blue_skyrise(int x_offset, int y_offset) {
	...
	// 3/17/2015: Copying first part from Programming Skills
	...
	move_slide_to_position(450);
	wait_for_move_done(600 + SKY1_Y_OFFSET);
	signed_move('r', 105 - SKY1_X_OFFSET, 127); //+/- 25
	wait1Msec(100);
	move('b', 515, 127);
	wait1Msec(300);
	wait_for_slide_done();
